...
app = FastAPI(
    title="Delphos API",
    version="1.8.0",
    description="Backend para simulaciones educativas empresariales - Fase 18: Mentores Virtuales de IA",
)
...
def root():
    return {
        "status": "online",
        "message": "Delphos API v1.8.0",
        "phase": "18 - Mentores Virtuales de IA",
    }
